...
python pretrain.py --use_checkpoint --logdir="no_dilation_0" --batch_size=1 --num_steps=6000 --lrdecay --eval_num=200 --lr=6e-7 --use_ssl_pretrained=pretrain/pretrained_models/model_swinvit.pt
...
# python pretrain.py --use_checkpoint  --logdir="no_dilation_1" --batch_size=1 --num_steps=2000 --lrdecay --eval_num=200 --lr=6e-7 --resume pretrain/runs/no_dilation_0/model_final_epoch.pt
