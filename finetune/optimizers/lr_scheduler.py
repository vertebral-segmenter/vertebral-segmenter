# Copyright 2020 - 2021 VbSeg Consortium
...
class _LRSchedulerVbSeg(_LRScheduler):
    ...
    def __init__(self, optimizer: Optimizer, end_lr: float, num_iter: int, last_epoch: int = -1) -> None:
        ...
        super(_LRSchedulerVbSeg, self).__init__(optimizer, last_epoch)


class LinearLR(_LRSchedulerVbSeg):
...
class ExponentialLR(_LRSchedulerVbSeg):
